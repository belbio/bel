...
EBNF_TEMPLATE_FILE="bel.ebnf.j2"
SCRIPT_TO_TEST_PARSER="parser_testing.py"
YAML_TO_EBNF_SCRIPT="yaml_to_ebnf.py"
...
do
    ...
    EBNF_SYNTAX_FILE="..\belpy\versions\bel_v$v.ebnf"
    PARSER_PY_FILE="..\belpy\versions\parser_v$v.py"
    YAML_FILE_NAME="..\belpy\versions\bel_v$v.yaml"
