...
#########################
class String(object):
    """Used for unknown strings - can't determine what kind of BEL Assertion component it is
    
    for BEL completion - the string will be searched against functions, relations and namespace entities
    """
